...
void SBomber::ProcessKBHit() {
  ...
  FileLoggerSingleton::getInstance().WriteToLog(std::string(__func__) + " was invoked. key = ", c);
...
void SBomber::TimeFinish() {
  ...
  FileLoggerSingleton::getInstance().WriteToLog(std::string(__func__) + " deltaTime = ", (int)deltaTime);
}
