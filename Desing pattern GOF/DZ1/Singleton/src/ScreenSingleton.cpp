...
public:
  virtual void ClrScr() override {
	FileLoggerSingleton::getInstance().WriteToLog("ClrScr invoke begin");
	getInternalInstance().ClrScr();
	FileLoggerSingleton::getInstance().WriteToLog("ClrScr invoke end");
  }
  virtual void GotoXY(double x, double y) override {

	FileLoggerSingleton::getInstance().WriteToLog("GotoXY invoke begin");
	getInternalInstance().GotoXY(x, y);
	FileLoggerSingleton::getInstance().WriteToLog("GotoXY invoke end");
  }
