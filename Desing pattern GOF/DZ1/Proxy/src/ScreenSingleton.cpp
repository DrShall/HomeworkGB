...
public:
  virtual void ClrScr() override {
	LoggerSingleton::getInstance().WriteToLog("ClrScr invoke begin");
	getInternalInstance().ClrScr();
	LoggerSingleton::getInstance().WriteToLog("ClrScr invoke end");
  }
  virtual void GotoXY(double x, double y) override {

	LoggerSingleton::getInstance().WriteToLog("GotoXY invoke begin");
	getInternalInstance().GotoXY(x, y);
	LoggerSingleton::getInstance().WriteToLog("GotoXY invoke end");
  }
